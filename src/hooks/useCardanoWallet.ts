/**
 * CIP-30 wallet connection: discovery, connect, address. Frontend business —
 * everything comes straight from the wallet api.
 */
...
/** The CIP-30 api enable() returns — used here only for address/balance reads. */
